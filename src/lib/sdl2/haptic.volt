 ...
 *  \sa SDL_HapticPeriodic
 */
enum SDL_HAPTIC_SAWTOOTHUP = (1<<4);
 ...
 *  \sa SDL_HapticPeriodic
 */
enum SDL_HAPTIC_SAWTOOTHDOWN = (1<<5);
 ...
 */
enum SDL_HAPTIC_AUTOCENTER = (1<<13);
 ...
 */
@property uint SDL_HAPTIC_INFINITY() { return cast(uint) -1; }
