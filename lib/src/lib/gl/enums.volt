...
enum uint GL_SHADER_BINARY_FORMAT_SPIR_V = 0x9551U;
enum uint GL_SPIR_V_BINARY = 0x9552U;
enum uint GL_PARAMETER_BUFFER = 0x80EEU;
enum uint GL_PARAMETER_BUFFER_BINDING = 0x80EFU;
enum uint GL_CONTEXT_FLAG_NO_ERROR_BIT = 0x00000008U;
enum uint GL_VERTICES_SUBMITTED = 0x82EEU;
enum uint GL_PRIMITIVES_SUBMITTED = 0x82EFU;
enum uint GL_VERTEX_SHADER_INVOCATIONS = 0x82F0U;
enum uint GL_TESS_CONTROL_SHADER_PATCHES = 0x82F1U;
enum uint GL_TESS_EVALUATION_SHADER_INVOCATIONS = 0x82F2U;
enum uint GL_GEOMETRY_SHADER_PRIMITIVES_EMITTED = 0x82F3U;
enum uint GL_FRAGMENT_SHADER_INVOCATIONS = 0x82F4U;
enum uint GL_COMPUTE_SHADER_INVOCATIONS = 0x82F5U;
enum uint GL_CLIPPING_INPUT_PRIMITIVES = 0x82F6U;
enum uint GL_CLIPPING_OUTPUT_PRIMITIVES = 0x82F7U;
enum uint GL_POLYGON_OFFSET_CLAMP = 0x8E1BU;
enum uint GL_SPIR_V_EXTENSIONS = 0x9553U;
enum uint GL_NUM_SPIR_V_EXTENSIONS = 0x9554U;
enum uint GL_TEXTURE_MAX_ANISOTROPY = 0x84FEU;
enum uint GL_MAX_TEXTURE_MAX_ANISOTROPY = 0x84FFU;
enum uint GL_TRANSFORM_FEEDBACK_OVERFLOW = 0x82ECU;
enum uint GL_TRANSFORM_FEEDBACK_STREAM_OVERFLOW = 0x82EDU;
...
enum uint GL_LAYOUT_DEPTH_READ_ONLY_STENCIL_ATTACHMENT_EXT = 0x9530U;
enum uint GL_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_EXT = 0x9531U;
